    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-lg-12">
          ...
          <br/>Design: <a href="https://templatemo.com/"  title="css templates">TemplateMo</a><br/>
        
          Distributed By: <a href="https://themewagon.com/" title="Bootstrap Template World">ThemeWagon</a>
        </p>
          </div>
        </div>
      </div>
